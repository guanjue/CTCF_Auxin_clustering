...
#time Rscript ~/scratch/ctcf_auxin/Mclust_pk/plot_fimo_score.box.6.R 'Mclust_a/Matched/match_c' Mclust_all.fimo.pdf
#time Rscript ~/scratch/ctcf_auxin/Mclust_pk/plot_fimo_score.box.6.R 'Decay_a/All/all_c' Mclust_all.fimo.pdf
...
p = p + scale_fill_manual(values=c("#999999", "#999999", "#999999", "#999999", "#FF8C00", "#FF4500"))
